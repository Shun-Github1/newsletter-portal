  ...
  static ThemeData _build(AppColors colors, Brightness brightness) {
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        titleLarge: colored(AppTypography.titleLarge, colors.textSecondary),
        titleMedium: colored(AppTypography.titleMedium, colors.textSecondary),
        titleSmall: colored(AppTypography.titleSmall, colors.textSecondary),
